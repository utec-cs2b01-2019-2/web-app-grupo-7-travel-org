...
<body class="seo_version">
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="calendar.html"><img src="images/logos/logo-seo.png" alt="image"></a>
                </div>
                        ...
                        <div id="message"></div>
                            <fieldset class="row-fluid">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                                    <form class="row" name="contactform" method="post" action="/registrar">
                                    ...
                                    <input type="email" name="correo" class="form-control" placeholder="Your Email">
                                    <input type="text" name="edad" class="form-control" placeholder="Your Age">
                                ...
                                <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <button type="submit" value="registrar" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Registrarse</button>
                                    </form>
    ...
    <section class="section nopad cac text-center">
        <a href="login.html"><h3>¿Ya tienes una cuenta? </h3></a>
    </section>
